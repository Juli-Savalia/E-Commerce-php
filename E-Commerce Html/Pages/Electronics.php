...
// Assuming category_id = 1 for electronics
$category = "Electronics";  // Change this based on which category you're filtering for
        ...
        <div class="w-full h-screen overflow-y-auto">
            ...
            <div class="p-8">
                <div class="container mx-auto">
                    ...
                    <h1 class="text-2xl font-semibold mb-2">Electronics</h1>
                    ...
                    <div id="product-container">
                        <h1 class="text-3xl font-bold mb-6">Electronics</h1>

                        <!-- Check if products are available -->
                        <div class="d-flex flex-wrap">
                            <?php if ($product_count > 0): ?>
                                <?php while ($product = mysqli_fetch_assoc($result)): ?>
                                    <div class="px-3 col-3 h-[450px]">
                                    <div class="bg-white shadow-md rounded p-4 h-100">
                                        <img src="Images/Electronics/<?php echo $product['image']; ?>"
                                             alt="<?php echo $product['product_name']; ?>"
                                             class="w-[150px] mx-auto h-[150px] object-cover mb-4" />
