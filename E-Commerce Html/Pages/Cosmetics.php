...
// Assuming category_id = 2 for Cosmetics
$category = "cosmetics";  // Change this based on which category you're filtering for
        ...
        <div class="w-full h-screen overflow-y-auto">
            ...
            <div class="p-8">
                <div class="container mx-auto">
                    ...
                    <h1 class="text-2xl font-semibold mb-2">Cosmetics</h1>
                    ...
                    <div id="product-container">
                        <h1 class="text-3xl font-bold mb-6">Cosmetics</h1>
                            ...
                            <?php if ($product_count > 0): ?>
                                <?php while ($product = mysqli_fetch_assoc($result)): ?>
                                    <div class="bg-white shadow-md rounded p-4">
                                        <img src="Images/Cosmetics/<?php echo $product['image']; ?>"
