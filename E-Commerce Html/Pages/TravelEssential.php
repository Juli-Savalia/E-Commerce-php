...
// Assuming category_id = 1 for TravelEssential
$category_id = 6;  // Change this based on which category you're filtering for
            ...
            <div class="p-8">
                <div class="container mx-auto">
                    <nav class="text-sm text-gray-600 mb-4">
                        ...
                        <span>TravelEssential</span>
                    </nav>

                    <h1 class="text-2xl font-semibold mb-2">TravelEssential</h1>
                    ...
                    <div id="product-container">
                        <h1 class="text-3xl font-bold mb-6">TravelEssential</h1>
                            ...
                            <?php if ($product_count > 0): ?>
                                <?php while ($product = mysqli_fetch_assoc($result)): ?>
                                    <div class="bg-white shadow-md rounded p-4">
                                        <img src="Images/TravelEssential/<?php echo $product['image']; ?>"
